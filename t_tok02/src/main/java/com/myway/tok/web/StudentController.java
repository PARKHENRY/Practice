...
public class StudentController {
	...
	// 방법1. return 값을 String 형으로 만들어주고 Model을 따로 장착 시키는 방법
	// - return 은 view의 이름을 명시해주고, view에서 사용될 model은 따로 주입을 하는 방법
	...
	// student.jsp의 요청에서 입력값을 받아서 result.jsp로 전달하는 맵핑
